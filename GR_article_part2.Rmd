...
Finally, we recode the ratings in numerical format, remove the language column which is now useless, and add a review_id column (to be able to identify to which review a word belongs).
...
The data is clean, we can save it to a file for future use.
