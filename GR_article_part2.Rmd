...
In this section, we are going to use the "positive" or "negative" aspect of words (from the *sentiments* dataset within the *tidytext* package) to see if it correlates with the ratings. In order to do that, we need to start by establishing a lexicon of words with a positive/negative score. 
...
It ends with us | 3      | 3381      | skipped      |
Me Before You   | 1      | 8090      | hated        |
